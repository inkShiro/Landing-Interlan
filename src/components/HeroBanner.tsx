...
const HeroBanner = () => {
  ...
  return (
    ...
    >
      <div
        id="banner-container"
        className={`3xl:translate-x-[-6rem] p-8 absolute inset-0 flex justify-between items-center bg-[#150140]`}
        style={{
      ...
      >
        <button
          ...
          className="3xl:translate-x-[6rem] z-10 text-white p-4 bg-black rounded-full hover:bg-gray-800 transition duration-200"
        >
          ...
          <div className={`relative w-full h-full p-12 transition-all duration-500 ${getAnimationClass(1)}`}>
            ...
            <Image
              ...
              style={{
                ...
                transform: isMobile
                ? isVisible
                  ? "translateY(-26vh) translateX(-18vw) scaleY(0.75) scaleX(0.75)"
                  : "translateY(-26vh) translateX(-18vw) scaleY(0.7) scaleX(0.7)"
                : isVisible
          ...
          <div className={`relative w-full h-full p-12 transition-all duration-500 ${getAnimationClass(2)}`}>
            ...
            <Image
              ...
              style={{
                ...
                transform: isMobile
                ? isVisible 
                  ? "translateY(-22vh) translateX(16vw) scaleY(0.85) scaleX(0.85)" 
                  : "translateY(-22vh) translateX(16vw) scaleY(0.8) scaleX(0.8)"
                : isVisible 
          ...
          <div className={`relative w-full h-full p-12 transition-all duration-500 ${getAnimationClass(3)}`}>
            ...
            <Image
              ...
              style={{
                ...
                transform: isMobile
                ? isVisible 
                  ? "translateY(20vh) translateX(16vw) scaleY(0.95) scaleX(0.95)" 
                  : "translateY(20vh) translateX(16vw) scaleY(0.9) scaleX(0.9)"
                : isVisible 
                  ? "translateY(14vh) translateX(-24vw) scaleY(0.35) scaleX(0.35)" 
                  : "translateY(14vh) translateX(-24vw) scaleY(0.3) scaleX(0.3)",
                transition: "transform 1s ease-in-out",
            ...
            <Image
              ...
              style={{
                ...
                transform: isMobile
                ? isVisible 
                  ? "translateY(-22vh) translateX(24vw) scaleY(0.85) scaleX(0.85)" 
                  : "translateY(-22vh) translateX(24vw) scaleY(0.8) scaleX(0.8)"
                : isVisible 
                  ? "translateY(-24vh) translateX(24vw) scaleY(0.35) scaleX(0.35)" 
                  : "translateY(-24vh) translateX(24vw) scaleY(0.3) scaleX(0.3)",
                transition: "transform 1s ease-in-out",

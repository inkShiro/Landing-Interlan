...
const BannerInterlan = () => {
  ...
  return (
    <section className="relative bg-white text-black py-12 px-4 h-[180px] w-auto">
      <div>
        <div className="absolute font-ginger inset-0 top-2 flex justify-center items-center z-10 overflow-hidden">
          <span
            className="font-ginger text-9xl text-black opacity-10 transform scale-x-[1.7] scale-y-[1.7] translate-y-[0px]" // Ajuste de la posición vertical
            style={{
        ...
        <div className={`w-[80vw] h-auto top-[40%] mx-auto absolute inset-0 flex justify-center items-center z-10`}>
          <div className={`relative z-10 grid ${isMobile ? 'grid-cols-1' : 'grid-cols-3'} gap-4 text-center mb-12 items-center`}>
            <div className="flex justify-center m-12">
              <span className="font-poppins text-2xl text-blue-500">
            ...
            <div className="flex justify-center">
              <Link href={links.plans}>
                <button className="py-2 px-6 bg-blue-500 text-white font-ginger rounded-lg hover:bg-blue-400 transition">
                  Ver planes
                </button>
              </Link>
            </div>
